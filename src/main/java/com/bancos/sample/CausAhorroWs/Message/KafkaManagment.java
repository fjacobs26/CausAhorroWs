package com.bancos.sample.CausAhorroWs.Message;
...
public class KafkaManagment {
    private final String topic;
    private final Properties props;

    public KafkaManagment(String brokers, String username, String password) {
    ...
    public static void main(String[] args) {
		...
		KafkaManagment c = new KafkaManagment(brokers, username, password);
        c.produce();
        c.consume();
    }
}
